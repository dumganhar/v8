...
#ifndef V8_HEAP_CPPGC_INTERNAL_OBJECT_START_BITMAP_H_
#define V8_HEAP_CPPGC_INTERNAL_OBJECT_START_BITMAP_H_
...
#endif  // V8_HEAP_CPPGC_INTERNAL_OBJECT_START_BITMAP_H_
